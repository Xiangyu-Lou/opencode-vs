...
// vsworker-seam: upstream suites assert exact hook and tool sets, so the bundled plugins stay out of them.
// Tests that exercise bundling clear this variable themselves.
