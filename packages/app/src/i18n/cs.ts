export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka VsWorker",
  ...
  "desktop.recovery.loadFailed": "VsWorker se nepodařilo načíst",
  "desktop.recovery.terminated": "VsWorker okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "VsWorker nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "VsWorker instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.opencodeMissing": "VsWorker není v této distribuci nainstalováno",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VsWorker aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v VsWorker.",
  ...
  "dialog.server.description": "Přepněte, ke kterému VsWorker serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola VsWorker v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace VsWorker v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace VsWorker v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker je připraveno v {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte VsWorker do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než VsWorker může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "VsWorker nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze VsWorker ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu VsWorker",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: VsWorker zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server VsWorker uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro VsWorker",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled VsWorker na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude VsWorker následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma VsWorker.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění VsWorker",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi VsWorker.",
