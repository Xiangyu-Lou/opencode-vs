export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker-documentatie",
  ...
  "desktop.recovery.loadFailed": "VsWorker kan niet worden geladen",
  "desktop.recovery.terminated": "Het VsWorker-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "VsWorker reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van VsWorker is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.opencodeMissing": "VsWorker is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De VsWorker-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in VsWorker te gebruiken.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in VsWorker te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in VsWorker te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke VsWorker-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorker controleren...",
  "wsl.onboarding.checkingOpencodeIn": "VsWorker controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "VsWorker bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "VsWorker bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk VsWorker bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "VsWorker bijwerken",
  "wsl.onboarding.opencodeReadyIn": "VsWorker is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer VsWorker in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat VsWorker een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "VsWorker kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens VsWorker opnieuw.",
  ...
  "help.tabs.introduction": "VsWorker Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van VsWorker ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het VsWorker-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: VsWorker ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de VsWorker-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor VsWorker",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe VsWorker eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of VsWorker het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van VsWorker aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer VsWorker wordt gestart",
  ...
  "settings.updates.toast.latest.title": "VsWorker is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van VsWorker.",
