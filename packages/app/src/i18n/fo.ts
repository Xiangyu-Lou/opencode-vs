export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker Skjøl",
  ...
  "desktop.menu.ariaLabel": "VsWorker valmynd",
  ...
  "desktop.recovery.loadFailed": "VsWorker miseydnaðist at heinta",
  "desktop.recovery.terminated": "VsWorker vindeygað endað óvæntað",
  "desktop.recovery.unresponsive": "VsWorker svarar ikki",
  ...
  "desktop.wsl.error.installOpencode": "VsWorker uppsetingin miseydnaðist",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er longu lagt afturat .",
  "desktop.wsl.error.opencodeMissing": "VsWorker er ikki sett upp í hesi distro",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker er sett upp men kundi ikki koyra",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker er ikki sett upp í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VsWorker dagføring liðug men {{distro}} greiðir enn frá {{installed}}; væntað {{expected}}.",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis modellir veitt av VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Skriva {{provider}} API-lykilin fyri at knýta kontuna saman og brúka {{provider}}-modell í VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " at savna inn tína heimildarkotu til at knýta tína kontu saman og brúka {{provider}} modellir í VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriva kotuna niðanfyri fyri at knýta tína kontu saman og brúka {{provider}} modellir í VsWorker.",
  ...
  "dialog.server.description": "Skift hvønn VsWorker ambætara henda appin hevur samband við.",
  ...
  "wsl.onboarding.checkingOpencode": "Kanna VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Kanna VsWorker í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Dagføring VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Dagføring VsWorker í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Dagfør VsWorker í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Dagfør VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker er klárt í {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker er klárt.",
  "wsl.onboarding.installOpencodeIn": "Set VsWorker upp í {{distro}}.",
  "wsl.onboarding.installOpencode": "Set upp VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker ikki innstillað",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Undirskipan til Linux) er kravd áðrenn VsWorker kann leggja ein WSL ambætara til",
  "wsl.onboarding.wslUnavailable.title": "WSL ikki tøkt",
  "wsl.onboarding.wslUnavailable.description": "VsWorker kundi ikki staðfesta WSL á hesi maskinuni.",
  "wsl.onboarding.installWsl": "Set upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurbyrja Windows fyri at klára at seta upp WSL, og opna síðani VsWorker aftur.",
  ...
  "help.tabs.introduction": "VsWorker Skrivaraborð er nú bygt rundan um flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ein nýggj útgáva av VsWorker ({{version}}) er nú tøk at seta upp.",
  ...
  "error.page.report.prefix": "Vinarliga melda hendan feilin til VsWorker toymið",
  ...
  "error.chain.mcpFailed": 'MCP ambætarin "{{name}}" miseydnaðist. Viðmæli, VsWorker stuðlar ikki MCP sannroynd enn.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker inniheldur ókeypis modellir so tú kanst byrja beinanvegin.",
  ...
  "app.name.desktop": "VsWorker Skrivaraborð",
  ...
  "settings.desktop.wsl.description": "Koyr VsWorker ambætaran inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Broyt sýnismálið fyri VsWorker",
  ...
  "settings.general.row.appearance.description": "Tillaga hvussu VsWorker sær út á tínari eind",
  "settings.general.row.colorScheme.title": "Litskipan",
  "settings.general.row.colorScheme.description": "Vel um VsWorker fylgir skipanini, ljósa ella myrka temanum",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tillaga hvussu VsWorker er tema.",
  ...
  "settings.updates.row.startup.description": "Kanna sjálvvirkandi fyri dagføringum, tá VsWorker byrjar",
  ...
  "settings.updates.toast.latest.description": "Tú koyrir nýggjastu útgávuna av VsWorker.",
