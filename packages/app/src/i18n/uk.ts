export const dict = {
  ...
  "desktop.menu.documentation": "Документація VsWorker",
  ...
  "desktop.menu.ariaLabel": "Меню VsWorker",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити VsWorker",
  "desktop.recovery.terminated": "Роботу вікна VsWorker несподівано завершено",
  "desktop.recovery.unresponsive": "VsWorker не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити VsWorker",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.opencodeMissing": "VsWorker не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker встановлено, але його не вдалося запустити",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення VsWorker завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у VsWorker.",
  ...
  "dialog.server.description": "Перемкніть сервер VsWorker, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка VsWorker у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення VsWorker у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть VsWorker у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть VsWorker у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в VsWorker потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "VsWorker не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія VsWorker ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді VsWorker",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, VsWorker ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер VsWorker всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу VsWorker",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд VsWorker на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи VsWorker використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему VsWorker.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску VsWorker",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію VsWorker.",
