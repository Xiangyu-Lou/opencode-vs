export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi VsWorker",
  ...
  "desktop.recovery.loadFailed": "VsWorker gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap VsWorker ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "VsWorker tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan VsWorker gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.opencodeMissing": "VsWorker tidak dipasang dalam distro ini",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini VsWorker selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam VsWorker.",
  ...
  "dialog.server.description": "Tukar pelayan VsWorker yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak VsWorker dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini VsWorker dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini VsWorker dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang VsWorker dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum VsWorker boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "VsWorker tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu VsWorker ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan VsWorker",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, VsWorker belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan VsWorker dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk VsWorker",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa VsWorker pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada VsWorker mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema VsWorker.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila VsWorker dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini VsWorker.",
