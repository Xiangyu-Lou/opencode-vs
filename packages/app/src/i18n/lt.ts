...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "VsWorker įkelti nepavyko",
  "VsWorker langas netikėtai užsidarė",
  "VsWorker neatsako",
  ...
  "VsWorker įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "VsWorker neįdiegtas distributyve {{distro}}",
  "VsWorker naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami VsWorker modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius VsWorker.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio VsWorker serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama VsWorker {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas VsWorker {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite VsWorker {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite VsWorker į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad VsWorker galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "VsWorker nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują VsWorker ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą VsWorker komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad VsWorker dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "VsWorker apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "VsWorker darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite VsWorker serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite VsWorker ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip VsWorker atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar VsWorker seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite VsWorker temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas VsWorker",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią VsWorker versiją.",
