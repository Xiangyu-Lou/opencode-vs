export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorker yüklənə bilmədi",
  "desktop.recovery.terminated": "VsWorker pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "VsWorker cavab vermir",
  ...
  "dialog.model.unpaid.freeModels.title": "VsWorker tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və VsWorker-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və VsWorker-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və VsWorker-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu VsWorker serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorker yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də VsWorker yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "VsWorker yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də VsWorker yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də VsWorker-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "VsWorker-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "VsWorker {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "VsWorker hazırdır.",
  "wsl.onboarding.installOpencodeIn": "VsWorker-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "VsWorker quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "VsWorker WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "VsWorker bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra VsWorker-u yenidən açın.",
  ...
  "help.tabs.introduction": "VsWorker Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VsWorker-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı VsWorker komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: VsWorker hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində VsWorker serverini işlət.",
  ...
  "settings.general.row.language.description": "VsWorker üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "VsWorker-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "VsWorker-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "VsWorker-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "VsWorker açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "VsWorker-un ən son versiyasından istifadə edirsiniz.",
