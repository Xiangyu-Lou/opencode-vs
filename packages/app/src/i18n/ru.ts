export const dict = {
  ...
  "desktop.menu.documentation": "Документация VsWorker",
  ...
  "desktop.recovery.loadFailed": "Не удалось загрузить VsWorker",
  "desktop.recovery.terminated": "Окно VsWorker неожиданно завершило работу",
  "desktop.recovery.unresponsive": "VsWorker не отвечает",
  ...
  "desktop.wsl.error.installOpencode": "Не удалось установить VsWorker",
  "desktop.wsl.error.alreadyAdded": "Дистрибутив {{distro}} уже добавлен",
  "desktop.wsl.error.opencodeMissing": "VsWorker не установлен в этом дистрибутиве",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker установлен, но его не удалось запустить",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker не установлен в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Обновление VsWorker завершено, но {{distro}} по-прежнему сообщает версию {{installed}}; ожидалась {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Введите ключ API {{provider}}, чтобы подключить аккаунт и использовать модели {{provider}} в VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в VsWorker.",
  ...
  "dialog.server.description": "Выберите сервер VsWorker, к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка VsWorker в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление VsWorker в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите VsWorker в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "VsWorker готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите VsWorker в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в VsWorker требуется WSL (Подсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "VsWorker не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте VsWorker.",
  ...
  "help.tabs.introduction": "Теперь работа в VsWorker Desktop организована с помощью вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Новая версия VsWorker ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде VsWorker",
  ...
  "error.chain.mcpFailed":
    'MCP-сервер "{{name}}" завершился с ошибкой. Обратите внимание: VsWorker пока не поддерживает MCP-авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер VsWorker внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения VsWorker",
  ...
  "settings.general.row.appearance.description": "Настройте внешний вид VsWorker на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли VsWorker системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление VsWorker.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске VsWorker",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию VsWorker.",
