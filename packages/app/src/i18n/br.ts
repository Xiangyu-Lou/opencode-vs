export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do VsWorker",
  ...
  "desktop.menu.ariaLabel": "Menu do VsWorker",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o VsWorker",
  "desktop.recovery.terminated": "A janela do VsWorker foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O VsWorker não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do VsWorker",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.opencodeMissing": "O VsWorker não está instalado nesta distribuição",
  "desktop.wsl.error.opencodeCannotRun": "O VsWorker está instalado, mas não pôde ser executado",
  "desktop.wsl.error.opencodeNotInstalled": "O VsWorker não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do VsWorker foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no VsWorker.",
  ...
  "dialog.server.description": "Trocar para qual servidor VsWorker este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o VsWorker em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o VsWorker em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o VsWorker em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o VsWorker",
  "wsl.onboarding.opencodeReadyIn": "O VsWorker está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O VsWorker está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o VsWorker em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o VsWorker possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O VsWorker não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o VsWorker novamente.",
  ...
  "help.tabs.introduction": "Agora, o VsWorker Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do VsWorker ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do VsWorker",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: VsWorker ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor VsWorker dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do VsWorker",
  ...
  "settings.general.row.appearance.description": "Personalize como o VsWorker aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o VsWorker segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o VsWorker é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o VsWorker iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do VsWorker.",
