export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorker laadimine ebaõnnestus",
  "desktop.recovery.terminated": "VsWorker aken suleti ootamatult",
  "desktop.recovery.unresponsive": "VsWorker ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "VsWorker installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.opencodeMissing": "VsWorker pole sellesse distrosse installitud",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VsWorker värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid VsWorker'is.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises VsWorker.",
  ...
  "dialog.server.description": "Lülitage, millise VsWorker serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorker kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "VsWorker kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "VsWorker värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "VsWorker värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda VsWorker jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige VsWorker asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui VsWorker saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "VsWorker ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse VsWorker ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast VsWorker meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, VsWorker ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "VsWorker Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage VsWorker server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke VsWorker kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas VsWorker teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas VsWorker järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas VsWorker on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui VsWorker käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse VsWorker uusimat versiooni.",
