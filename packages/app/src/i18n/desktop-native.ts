...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "VsWorker failed to load",
  "desktop.recovery.terminated": "VsWorker window terminated unexpectedly",
  "desktop.recovery.unresponsive": "VsWorker is not responding",
