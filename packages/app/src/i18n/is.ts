...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða VsWorker",
  "VsWorker-glugganum var óvænt lokað",
  "VsWorker svarar ekki",
  ...
  "VsWorker er ekki uppsett í {{distro}}",
  "Uppfærslu VsWorker lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í VsWorker.",
  ...
  "dialog.server.description": "Skiptu um hvaða VsWorker miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar VsWorker í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir VsWorker í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu VsWorker í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp VsWorker í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en VsWorker getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "VsWorker gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan VsWorker aftur.",
  ...
  "help.tabs.introduction": "VsWorker Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af VsWorker ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til VsWorker teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, VsWorker styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "VsWorker inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "VsWorker skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu VsWorker netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir VsWorker",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig VsWorker lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort VsWorker fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig VsWorker er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar VsWorker ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af VsWorker.",
