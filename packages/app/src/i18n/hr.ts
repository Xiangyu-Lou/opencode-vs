...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "VsWorker se nije uspio učitati",
  "Prozor aplikacije VsWorker neočekivano je zatvoren",
  "VsWorker ne reagira",
  ...
  "Instalacija aplikacije VsWorker nije uspjela",
  ...
  "VsWorker nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije VsWorker je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u VsWorker.",
  ...
  "dialog.server.description": "Promijenite na koji se VsWorker poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera VsWorker u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje VsWorker u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte VsWorker u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte VsWorker u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte VsWorker",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što VsWorker može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "VsWorker nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite VsWorker.",
  ...
  "help.tabs.introduction": "Radna površina VsWorker sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija VsWorker ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku VsWorker timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, VsWorker još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "VsWorker Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite VsWorker poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za VsWorker",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako VsWorker izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li VsWorker slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je VsWorker tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se VsWorker pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju VsWorker.",
