export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker hujjatlari",
  ...
  "desktop.menu.ariaLabel": "VsWorker menyusi",
  ...
  "desktop.recovery.loadFailed": "VsWorker yuklanmadi",
  "desktop.recovery.terminated": "VsWorker oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "VsWorker javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "VsWorker oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.opencodeMissing": "VsWorker ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "VsWorker yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "VsWorker tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va VsWorker’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va VsWorker da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va VsWorker da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi VsWorker serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorker tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "VsWorker {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "VsWorker yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "VsWorker {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "VsWorker-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "VsWorker-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "VsWorker {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "VsWorker tayyor.",
  "wsl.onboarding.installOpencodeIn": "VsWorker-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "VsWorker-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "VsWorker WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "VsWorker WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra VsWorker-ni qayta oching.",
  ...
  "help.tabs.introduction": "VsWorker Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VsWorker ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida VsWorker jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, VsWorker hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "VsWorker bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi VsWorker serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "VsWorker uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "VsWorker qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "VsWorker tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "VsWorker mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "VsWorker ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz VsWorker oxirgi versiyasini ishga tushiryapsiz.",
