export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de VsWorker",
  ...
  "desktop.menu.ariaLabel": "Menú de VsWorker",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar VsWorker",
  "desktop.recovery.terminated": "La ventana de VsWorker se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "VsWorker no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar VsWorker",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.opencodeMissing": "VsWorker no está instalado en esta distribución",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de VsWorker finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en VsWorker.",
  ...
  "dialog.server.description": "Cambiar el servidor de VsWorker al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando VsWorker en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando VsWorker en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza VsWorker en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala VsWorker en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que VsWorker pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "VsWorker no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de VsWorker ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de VsWorker",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: VsWorker aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor VsWorker dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para VsWorker",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve VsWorker en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si VsWorker sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de VsWorker.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia VsWorker",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de VsWorker.",
