export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل VsWorker",
  "desktop.recovery.terminated": "توقفت نافذة VsWorker بشكل غير متوقع",
  "desktop.recovery.unresponsive": "VsWorker لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت VsWorker",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.opencodeMissing": "VsWorker غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث VsWorker، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من VsWorker",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في VsWorker.",
  ...
  "dialog.server.description": "تبديل خادم VsWorker الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من VsWorker في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث VsWorker في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث VsWorker في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت VsWorker في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن VsWorker من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على VsWorker التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح VsWorker.",
  ...
  "help.tabs.introduction": "أصبح VsWorker Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من VsWorker ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق VsWorker",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن VsWorker لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن VsWorker نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم VsWorker داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ VsWorker",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور VsWorker على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان VsWorker يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة VsWorker.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل VsWorker",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من VsWorker.",
