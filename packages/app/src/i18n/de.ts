...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in VsWorker zu nutzen.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in VsWorker zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in VsWorker zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den VsWorker-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorker wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "VsWorker in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "VsWorker wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "VsWorker in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie VsWorker in {{distro}}.",
  "wsl.onboarding.updateOpencode": "VsWorker aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "VsWorker ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "VsWorker ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie VsWorker in {{distro}}.",
  "wsl.onboarding.installOpencode": "VsWorker installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor VsWorker einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "VsWorker konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann VsWorker erneut.",
  ...
  "toast.update.description": "Eine neue Version von VsWorker ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem VsWorker-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: VsWorker unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "VsWorker mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "VsWorker enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "VsWorker Desktop",
  ...
  "settings.desktop.wsl.description": "VsWorker-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für VsWorker ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie VsWorker auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob VsWorker dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von VsWorker anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von VsWorker automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "VsWorker ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von VsWorker wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "VsWorker konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das VsWorker-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "VsWorker reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "VsWorker-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.opencodeMissing": "VsWorker ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das VsWorker-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "VsWorker Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
