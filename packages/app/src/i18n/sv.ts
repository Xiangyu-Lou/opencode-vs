export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorker kunde inte läsas in",
  "desktop.recovery.terminated": "VsWorker-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "VsWorker svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av VsWorker misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.opencodeMissing": "VsWorker är inte installerat i den här distributionen",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker är installerat men kunde inte köras",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "VsWorker-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i VsWorker.",
  ...
  "dialog.server.description": "Växla vilken VsWorker-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar VsWorker i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar VsWorker i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera VsWorker i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera VsWorker i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan VsWorker kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "VsWorker kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan VsWorker igen.",
  ...
  "help.tabs.introduction": "VsWorker Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av VsWorker ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till VsWorker-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, VsWorker stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör VsWorker-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för VsWorker",
  ...
  "settings.general.row.appearance.description": "Anpassa hur VsWorker ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om VsWorker följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa VsWorkers tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när VsWorker startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av VsWorker.",
