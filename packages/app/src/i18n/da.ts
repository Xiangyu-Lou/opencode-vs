export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i VsWorker.",
  ...
  "dialog.server.description": "Skift hvilken VsWorker-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker VsWorker i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer VsWorker i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater VsWorker i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før VsWorker kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "VsWorker kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter VsWorker igen.",
  ...
  "toast.update.description": "En ny version af VsWorker ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til VsWorker-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, VsWorker understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør VsWorker-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for VsWorker",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan VsWorker ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om VsWorker skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas VsWorkers tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når VsWorker starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af VsWorker.",
  ...
  "desktop.recovery.loadFailed": "VsWorker kunne ikke indlæses",
  "desktop.recovery.terminated": "VsWorker-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af VsWorker mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.opencodeMissing": "VsWorker er ikke installeret i denne distribution",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker er installeret, men kunne ikke køre",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af VsWorker er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "VsWorker Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
