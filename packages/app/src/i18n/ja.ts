export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorkerを読み込めませんでした",
  "desktop.recovery.terminated": "VsWorkerのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "VsWorkerが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "VsWorkerのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.opencodeMissing": "このディストリビューションにはVsWorkerがインストールされていません",
  "desktop.wsl.error.opencodeCannotRun": "VsWorkerはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはVsWorkerがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "VsWorkerのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "VsWorkerが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、VsWorkerで{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してVsWorkerで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、VsWorkerで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するVsWorkerサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorkerを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のVsWorkerを確認中...",
  "wsl.onboarding.updatingOpencode": "VsWorkerを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のVsWorkerを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のVsWorkerを更新してください。",
  "wsl.onboarding.updateOpencode": "VsWorkerを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のVsWorkerの準備ができました。",
  "wsl.onboarding.opencodeReady": "VsWorkerの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にVsWorkerをインストールしてください。",
  "wsl.onboarding.installOpencode": "VsWorkerをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorkerがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "VsWorkerでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、VsWorkerをもう一度開いてください。",
  ...
  "help.tabs.introduction": "VsWorker Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VsWorkerの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをVsWorkerチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: VsWorkerはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "VsWorkerには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でVsWorkerサーバーを実行します。",
  ...
  "settings.general.row.language.description": "VsWorkerの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのVsWorkerの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "VsWorkerがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "VsWorkerのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "VsWorker の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "VsWorker は最新バージョンです。",
