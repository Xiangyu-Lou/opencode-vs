export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni VsWorker",
  ...
  "desktop.menu.ariaLabel": "Menuja VsWorker",
  ...
  "desktop.recovery.loadFailed": "VsWorker nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja VsWorker u mbyll papritur",
  "desktop.recovery.unresponsive": "VsWorker nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i VsWorker dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.opencodeMissing": "VsWorker nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i VsWorker përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në VsWorker.",
  ...
  "dialog.server.description": "Ndrysho me cilin server VsWorker lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon VsWorker në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "VsWorker po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson VsWorker në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso VsWorker në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker është gati në {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni VsWorker në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se VsWorker të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "VsWorker nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i VsWorker ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i VsWorker",
  ...
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, VsWorker nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin VsWorker brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për VsWorker",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket VsWorker në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse VsWorker ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e VsWorker.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset VsWorker",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të VsWorker.",
