...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorker 載入失敗",
  "desktop.recovery.terminated": "VsWorker 視窗意外終止",
  "desktop.recovery.unresponsive": "VsWorker 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "VsWorker 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.opencodeMissing": "此發行版中未安裝 VsWorker",
  "desktop.wsl.error.opencodeCannotRun": "已安裝 VsWorker，但無法執行",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安裝 VsWorker",
  "desktop.wsl.error.updateVersion":
    "VsWorker 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "VsWorker 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 VsWorker 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 VsWorker 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 VsWorker 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 VsWorker 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 VsWorker...",
  ...
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 VsWorker 已就緒。",
  "wsl.onboarding.opencodeReady": "VsWorker 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 VsWorker。",
  "wsl.onboarding.installOpencode": "安裝 VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安裝 VsWorker",
  ...
  "wsl.onboarding.wslUnavailable.description": "VsWorker 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 VsWorker。",
  ...
  "help.tabs.introduction": "VsWorker Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VsWorker 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 VsWorker 團隊",
  ...
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：VsWorker 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "VsWorker 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 VsWorker 伺服器。",
  ...
  "settings.general.row.language.description": "變更 VsWorker 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 VsWorker 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 VsWorker 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 VsWorker 的主題。",
  ...
  "settings.updates.row.startup.description": "在 VsWorker 啟動時自動檢查更新",
