export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker Փաստաթղթեր",
  ...
  "desktop.menu.ariaLabel": "VsWorker մենյու",
  ...
  "desktop.recovery.loadFailed": "VsWorker չհաջողվեց բեռնել",
  "desktop.recovery.terminated": "VsWorker պատուհանն անսպասելիորեն ավարտվեց",
  "desktop.recovery.unresponsive": "VsWorker-ը չի արձագանքում",
  ...
  "dialog.model.unpaid.freeModels.title": "Անվճար մոդելները տրամադրվում են VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Մուտքագրեք ձեր {{provider}} API բանալին՝ ձեր հաշիվը միացնելու և VsWorker-ում {{provider}} մոդելներ օգտագործելու համար։",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " հավաքել ձեր թույլտվության կոդը՝ ձեր հաշիվը միացնելու և VsWorker-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " և մուտքագրեք ստորև ծածկագիրը՝ ձեր հաշիվը միացնելու և VsWorker-ում {{provider}} մոդելներ օգտագործելու համար:",
  ...
  "dialog.server.description": "Փոխարկեք, թե որ VsWorker սերվերին է միանում այս հավելվածը։",
  ...
  "wsl.onboarding.checkingOpencode": "Ստուգում է VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Ստուգում է VsWorker-ը {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Թարմացվում է VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Թարմացվում է VsWorker-ը {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Թարմացնել VsWorker-ը {{distro}}-ում։",
  "wsl.onboarding.updateOpencode": "Թարմացնել VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker պատրաստ է {{distro}}-ում։",
  "wsl.onboarding.opencodeReady": "VsWorker պատրաստ է։",
  "wsl.onboarding.installOpencodeIn": "Տեղադրեք VsWorker-ը {{distro}}-ում։",
  "wsl.onboarding.installOpencode": "Տեղադրեք VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker տեղադրված չէ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Ենթահամակարգը Linux-ի համար) անհրաժեշտ է, որպեսզի VsWorker-ը կարողանա ավելացնել WSL սերվեր",
  "wsl.onboarding.wslUnavailable.title": "WSL անհասանելի է",
  "wsl.onboarding.wslUnavailable.description": "VsWorker-ը չկարողացավ հաստատել WSL-ն այս մեքենայի վրա։",
  "wsl.onboarding.installWsl": "Տեղադրեք WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Վերագործարկեք Windows՝ WSL-ի տեղադրումն ավարտելու համար, այնուհետև նորից բացեք VsWorker։",
  ...
  "help.tabs.introduction": "VsWorker Desktop-ն այժմ կառուցված է ներդիրների շուրջ։",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VsWorker-ի ({{version}}) նոր տարբերակը այժմ հասանելի է տեղադրման համար:",
  ...
  "error.page.report.prefix": "Խնդրում ենք հայտնել այս սխալի մասին VsWorker թիմին",
  ...
  "error.chain.mcpFailed":
    "MCP «{{name}}» սերվերը ձախողվեց: Նկատի ունեցեք, որ VsWorker-ը դեռ չի աջակցում MCP նույնականացումը:",
  ...
  "sidebar.gettingStarted.line1": "VsWorker ներառում է անվճար մոդելներ, որպեսզի կարողանաք անմիջապես սկսել:",
  ...
  "settings.desktop.wsl.description": "Գործարկեք VsWorker սերվերը WSL-ի ներսում՝ Windows-ում։",
  ...
  "settings.general.row.language.description": "Փոխել ցուցադրման լեզուն VsWorker",
  ...
  "settings.general.row.appearance.description": "Անհատականացրեք, թե ինչպես է VsWorker տեսքը ձեր սարքում",
  "settings.general.row.colorScheme.title": "Գունային սխեման",
  "settings.general.row.colorScheme.description": "Ընտրեք՝ VsWorker-ը հետևում է համակարգին, թեթև թե մուգ թեմային",
  "settings.general.row.theme.title": "Թեմա",
  "settings.general.row.theme.description": "Անհատականացրեք, թե ինչպես է VsWorker-ի թեմատիկությունը։",
  ...
  "settings.updates.row.startup.description": "Ավտոմատ կերպով ստուգեք թարմացումների համար, երբ VsWorker-ը գործարկվի",
  ...
  "settings.updates.toast.latest.description": "Դուք օգտագործում եք VsWorker-ի վերջին տարբերակը։",
