export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker دستاویزات",
  ...
  "desktop.menu.ariaLabel": "VsWorker مینو",
  ...
  "desktop.recovery.loadFailed": "VsWorker لوڈ نہیں ہو سکا",
  "desktop.recovery.terminated": "VsWorker ونڈو غیر متوقع طور پر بند ہو گئی",
  "desktop.recovery.unresponsive": "VsWorker جواب نہیں دے رہا",
  ...
  "desktop.wsl.error.installOpencode": "VsWorker کی تنصیب ناکام ہو گئی",
  "desktop.wsl.error.alreadyAdded": "{{distro}} پہلے ہی شامل ہے",
  "desktop.wsl.error.opencodeMissing": "اس ڈسٹری بیوشن میں VsWorker انسٹال نہیں ہے",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker انسٹال ہے لیکن چل نہیں سکا",
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} میں VsWorker انسٹال نہیں ہے",
  "desktop.wsl.error.updateVersion":
    "VsWorker کی اپ ڈیٹ مکمل ہو گئی لیکن {{distro}} اب بھی {{installed}} کی اطلاع دے رہا ہے؛ متوقع ورژن {{expected}} ہے",
  ...
  "dialog.model.unpaid.freeModels.title": "VsWorker کے ذریعہ فراہم کردہ مفت ماڈلز",
  ...
  "provider.connect.apiKey.description":
    "اپنا اکاؤنٹ منسلک کرنے اور VsWorker میں {{provider}} ماڈلز استعمال کرنے کے لیے اپنی {{provider}} API کلید درج کریں۔",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "، اپنا اجازت نامہ حاصل کریں، اکاؤنٹ منسلک کریں اور VsWorker میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " اور نیچے دیا گیا کوڈ درج کرکے اپنا اکاؤنٹ منسلک کریں اور VsWorker میں {{provider}} ماڈلز استعمال کریں۔",
  ...
  "dialog.server.description": "سوئچ کریں کہ یہ ایپ کس VsWorker سرور سے منسلک ہے۔",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorker چیک کیا جا رہا ہے...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} میں VsWorker چیک کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencode": "VsWorker کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} میں VsWorker کو اپ ڈیٹ کیا جا رہا ہے...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} میں VsWorker کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.updateOpencode": "VsWorker کو اپ ڈیٹ کریں۔",
  "wsl.onboarding.opencodeReadyIn": "VsWorker {{distro}} میں تیار ہے۔",
  "wsl.onboarding.opencodeReady": "VsWorker تیار ہے۔",
  "wsl.onboarding.installOpencodeIn": "{{distro}} میں VsWorker انسٹال کریں۔",
  "wsl.onboarding.installOpencode": "VsWorker انسٹال کریں۔",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker انسٹال نہیں ہے۔",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows سب سسٹم برائے Linux) کی ضرورت ہے اس سے پہلے کہ VsWorker WSL سرور شامل کر سکے۔",
  "wsl.onboarding.wslUnavailable.title": "WSL دستیاب نہیں ہے۔",
  "wsl.onboarding.wslUnavailable.description": "VsWorker اس مشین پر WSL کی تصدیق نہیں کر سکا۔",
  "wsl.onboarding.installWsl": "WSL انسٹال کریں۔",
  "wsl.onboarding.windowsRestartRequired":
    "WSL انسٹال کرنے کے لیے Windows کو دوبارہ شروع کریں، پھر VsWorker کو دوبارہ کھولیں۔",
  ...
  "help.tabs.introduction": "VsWorker Desktop اب ٹیبز پر مبنی ہے۔",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VsWorker ({{version}}) کا ایک نیا ورژن اب انسٹال کرنے کے لیے دستیاب ہے۔",
  ...
  "error.page.report.prefix": "براہ کرم VsWorker ٹیم کو اس غلطی کی اطلاع دیں۔",
  ...
  "error.chain.mcpFailed": 'MCP سرور "{{name}}" ناکام ہو گیا۔ نوٹ، VsWorker ابھی تک MCP تصدیق کو سپورٹ نہیں کرتا ہے۔',
  ...
  "sidebar.gettingStarted.line1": "VsWorker میں مفت ماڈل شامل ہیں لہذا آپ فوری طور پر شروع کر سکتے ہیں۔",
  ...
  "app.name.desktop": "VsWorker ڈیسک ٹاپ",
  ...
  "settings.desktop.wsl.description": "Windows پر WSL کے اندر VsWorker سرور چلائیں۔",
  ...
  "settings.general.row.language.description": "VsWorker کے لیے ڈسپلے کی زبان تبدیل کریں۔",
  ...
  "settings.general.row.appearance.description": "اپنی مرضی کے مطابق بنائیں کہ آپ کے آلے پر VsWorker کیسا لگتا ہے۔",
  "settings.general.row.colorScheme.title": "رنگ سکیم",
  "settings.general.row.colorScheme.description":
    "منتخب کریں کہ آیا VsWorker سسٹم، لائٹ یا ڈارک تھیم کی پیروی کرتا ہے۔",
  "settings.general.row.theme.title": "تھیم",
  "settings.general.row.theme.description": "VsWorker کی تھیم حسب ضرورت بنائیں۔",
  ...
  "settings.updates.row.startup.description": "VsWorker لانچ ہونے پر اپ ڈیٹس کے لیے خودکار طور پر چیک کریں۔",
  ...
  "settings.updates.toast.latest.description": "آپ VsWorker کا تازہ ترین ورژن چلا رہے ہیں۔",
