export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorker መጫን አልቻለም",
  "desktop.recovery.terminated": "VsWorker መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "VsWorker ምላሽ እየሰጠ አይደለም",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በVsWorker",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በVsWorker ይጠቀሙ።",
  ...
  "provider.connect.opencodeZen.line1": "VsWorker ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በVsWorker ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በVsWorker ይጠቀሙ።",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው VsWorker አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "VsWorkerን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ VsWorker በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን VsWorker በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.opencodeReady": "VsWorker ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን VsWorker በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorkerአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) VsWorker WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "VsWorker በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ VsWorker።",
  ...
  "help.tabs.introduction": "VsWorker ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የVsWorker ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለVsWorker ቡድን ያሳውቁ",
  ...
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ VsWorker እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "VsWorker ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "VsWorker ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የVsWorker አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለVsWorker",
  ...
  "settings.general.row.appearance.description": "VsWorkerበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "VsWorker ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "VsWorker ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "VsWorker ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የVsWorker እትም እያሄዱ ነው።",
