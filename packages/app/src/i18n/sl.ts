export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "VsWorker ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno VsWorker se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "VsWorker se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev VsWorker ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.opencodeMissing": "VsWorker ni nameščen v tej distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev VsWorker je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v VsWorker.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom VsWorker se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje VsWorker ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje VsWorker v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje VsWorker ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje VsWorker v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite VsWorker v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite VsWorker v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko VsWorker doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "VsWorker ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica VsWorker ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi VsWorker",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, VsWorker še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik VsWorker znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za VsWorker",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako VsWorker izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali VsWorker sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo VsWorker.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene VsWorker",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico VsWorker.",
