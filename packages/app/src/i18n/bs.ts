export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za VsWorker",
  ...
  "desktop.menu.ariaLabel": "VsWorker meni",
  ...
  "desktop.recovery.loadFailed": "VsWorker se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor VsWorker-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "VsWorker ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija VsWorker-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.opencodeMissing": "VsWorker nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje VsWorker-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u VsWorker-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u VsWorker-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u VsWorker-u.",
  ...
  "dialog.server.description": "Promijeni na koji se VsWorker server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera VsWorker u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje VsWorker u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj VsWorker u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj VsWorker u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi VsWorker mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "VsWorker nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija VsWorker-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku VsWorker timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: VsWorker još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni VsWorker server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u VsWorker-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako VsWorker izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li VsWorker prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu VsWorker-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se VsWorker pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju VsWorker-a.",
