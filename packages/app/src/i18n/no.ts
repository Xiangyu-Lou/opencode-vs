...
export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "VsWorker-meny",
  ...
  "desktop.recovery.loadFailed": "VsWorker kunne ikke lastes inn",
  "desktop.recovery.terminated": "VsWorker-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "VsWorker svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av VsWorker mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.opencodeMissing": "VsWorker er ikke installert i denne distribusjonen",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker er installert, men kunne ikke kjøres",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av VsWorker er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i VsWorker.",
  ...
  "dialog.server.description": "Bytt hvilken VsWorker-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av VsWorker ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til VsWorker-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at VsWorker ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør VsWorker-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for VsWorker",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan VsWorker ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om VsWorker skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i VsWorker.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når VsWorker starter",
  ...
  "settings.updates.toast.latest.title": "VsWorker er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av VsWorker.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker VsWorker i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer VsWorker i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater VsWorker i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer VsWorker i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før VsWorker kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "VsWorker kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter VsWorker på nytt.",
  ...
  "help.tabs.introduction": "VsWorker Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
