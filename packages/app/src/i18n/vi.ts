export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu VsWorker",
  ...
  "desktop.recovery.loadFailed": "Không tải được VsWorker",
  "desktop.recovery.terminated": "Cửa sổ VsWorker đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "VsWorker không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được VsWorker",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.opencodeMissing": "VsWorker chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật VsWorker nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do VsWorker cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong VsWorker.",
  ...
  "dialog.server.description": "Chuyển máy chủ VsWorker mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra VsWorker trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật VsWorker trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật VsWorker trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt VsWorker trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi VsWorker có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "VsWorker không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của VsWorker ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm VsWorker",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: VsWorker chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ VsWorker bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho VsWorker",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của VsWorker trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem VsWorker tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của VsWorker.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi VsWorker khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của VsWorker.",
