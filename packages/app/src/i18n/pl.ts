export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja VsWorker",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać VsWorker",
  "desktop.recovery.terminated": "Okno VsWorker zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "VsWorker nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować VsWorker",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.opencodeMissing": "Program VsWorker nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.opencodeCannotRun": "Program VsWorker jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja VsWorker została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w VsWorker.",
  ...
  "dialog.server.description": "Przełącz serwer VsWorker, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie VsWorker w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie VsWorker w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj VsWorker w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj VsWorker w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim VsWorker będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "VsWorker nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja VsWorker ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu VsWorker",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: VsWorker nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "VsWorker zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer VsWorker wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla VsWorker",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd VsWorker na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy VsWorker ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw VsWorker.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania VsWorker",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji VsWorker.",
