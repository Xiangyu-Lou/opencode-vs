...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorker yüklenemedi",
  "desktop.recovery.terminated": "VsWorker penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "VsWorker yanıt vermiyor",
  ...
  "dialog.model.unpaid.freeModels.title": "VsWorker tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve VsWorker'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak VsWorker'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak VsWorker'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi VsWorker sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "VsWorker kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde VsWorker kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "VsWorker güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde VsWorker güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki VsWorker'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "VsWorker'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde VsWorker hazır.",
  "wsl.onboarding.opencodeReady": "VsWorker hazır.",
  "wsl.onboarding.installOpencodeIn": "VsWorker'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "VsWorker'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "VsWorker'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "VsWorker bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından VsWorker'u tekrar açın.",
  ...
  "help.tabs.introduction": "VsWorker Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "VsWorker'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı VsWorker ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: VsWorker henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "VsWorker Masaüstü",
  ...
  "settings.desktop.wsl.description": "VsWorker sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "VsWorker'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "VsWorker'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "VsWorker'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "VsWorker'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "VsWorker başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "VsWorker'un en son sürümünü kullanıyorsunuz.",
