export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker dokumentācija",
  ...
  "desktop.menu.ariaLabel": "VsWorker izvēlne",
  ...
  "desktop.recovery.loadFailed": "Neizdevās ielādēt VsWorker",
  "desktop.recovery.terminated": "VsWorker logs negaidīti aizvērts",
  "desktop.recovery.unresponsive": "VsWorker neatbild",
  ...
  "dialog.model.unpaid.freeModels.title": "Bezmaksas modeļi no VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Ievadiet savu {{provider}} API atslēgu, lai savienotu kontu un izmantotu {{provider}} modeļus VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", lai saņemtu autorizācijas kodu, savienotu kontu un izmantotu {{provider}} modeļus VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " un ievadiet zemāk redzamo kodu, lai savienotu kontu un izmantotu {{provider}} modeļus VsWorker.",
  ...
  "dialog.server.description": "Mainiet, pie kura VsWorker servera šī lietotne pieslēdzas.",
  ...
  "wsl.onboarding.checkingOpencode": "Pārbaudu VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Pārbaudu VsWorker distribūcijā {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atjauninu VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Atjauninu VsWorker distribūcijā {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atjauniniet VsWorker distribūcijā {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atjauniniet VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker ir gatavs distribūcijā {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker ir gatavs.",
  "wsl.onboarding.installOpencodeIn": "Instalējiet VsWorker distribūcijā {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalējiet VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker nav instalēts",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Pirms VsWorker var pievienot WSL serveri, nepieciešams WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nav pieejams",
  "wsl.onboarding.wslUnavailable.description": "VsWorker neizdevās pārbaudīt WSL šajā datorā.",
  "wsl.onboarding.installWsl": "Instalēt WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartējiet Windows, lai pabeigtu WSL instalēšanu, pēc tam atveriet VsWorker no jauna.",
  ...
  "help.tabs.introduction": "VsWorker Desktop tagad balstās uz cilnēm.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Pieejama jauna VsWorker versija ({{version}}) instalēšanai.",
  ...
  "error.page.report.prefix": "Lūdzu, ziņojiet par šo kļūdu VsWorker komandai",
  ...
  "error.chain.mcpFailed":
    'MCP serveris "{{name}}" neizdevās. Ņemiet vērā, VsWorker vēl neatbalsta MCP autentifikāciju.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker ietver bezmaksas modeļus, lai varētu sākt uzreiz.",
  ...
  "app.name.desktop": "VsWorker darbvirsma",
  ...
  "settings.desktop.wsl.description": "Palaist VsWorker serveri WSL vidē uz Windows.",
  ...
  "settings.general.row.language.description": "Mainīt VsWorker saskarnes valodu",
  ...
  "settings.general.row.appearance.description": "Pielāgojiet, kā VsWorker izskatās jūsu ierīcē",
  "settings.general.row.colorScheme.title": "Krāsu shēma",
  "settings.general.row.colorScheme.description":
    "Izvēlieties, vai VsWorker sekos sistēmas, gaišajai vai tumšajai tēmai",
  "settings.general.row.theme.title": "Tēma",
  "settings.general.row.theme.description": "Pielāgojiet VsWorker tēmu.",
  ...
  "settings.updates.row.startup.description": "Automātiski pārbaudīt atjauninājumus, palaižot VsWorker",
  ...
  "settings.updates.toast.latest.description": "Jūs izmantojat jaunāko VsWorker versiju.",
