export const dict = {
  ...
  "desktop.menu.documentation": "VsWorker Documentació",
  ...
  "desktop.menu.ariaLabel": "menú VsWorker.",
  ...
  "desktop.recovery.loadFailed": "VsWorker no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra VsWorker s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "VsWorker no respon",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a VsWorker.",
  ...
  "dialog.server.description": "Canvia a quin VsWorker servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant VsWorker a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant VsWorker a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza VsWorker a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker està llest a {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu VsWorker a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que VsWorker pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "VsWorker no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de VsWorker ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip VsWorker.",
  ...
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que VsWorker encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "VsWorker Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor VsWorker dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a VsWorker",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu VsWorker al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si VsWorker segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de VsWorker.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï VsWorker.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de VsWorker.",
