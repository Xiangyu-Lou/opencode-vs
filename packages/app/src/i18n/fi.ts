export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "VsWorkern tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja VsWorkerssa.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja VsWorkerssa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja VsWorkerssa.",
  ...
  "dialog.server.description": "Vaihda VsWorker-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan VsWorkera...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan VsWorkera kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään VsWorkera...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään VsWorkera kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä VsWorker jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna VsWorker jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorkera ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin VsWorker voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "VsWorker ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten VsWorker uudelleen.",
  ...
  "toast.update.description": "VsWorkern uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä VsWorker-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että VsWorker ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita VsWorker-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda VsWorkern näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä VsWorker näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö VsWorker järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta VsWorkern teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun VsWorker käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät VsWorkern uusinta versiota.",
  ...
  "desktop.menu.documentation": "VsWorker-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "VsWorker-valikko",
  ...
  "desktop.recovery.loadFailed": "VsWorkern lataaminen epäonnistui",
  "desktop.recovery.terminated": "VsWorker-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "VsWorker ei vastaa",
  ...
  "help.tabs.introduction": "VsWorker Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
