export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in VsWorker.",
  ...
  "dialog.server.description": "Cambia il server VsWorker a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo VsWorker in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento VsWorker in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna VsWorker in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa VsWorker in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che VsWorker possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "VsWorker non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di VsWorker ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team VsWorker",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: VsWorker non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server VsWorker all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per VsWorker",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di VsWorker sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se VsWorker segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di VsWorker.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di VsWorker",
  ...
  "settings.updates.toast.latest.title": "VsWorker è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di VsWorker.",
  ...
  "desktop.menu.documentation": "Documentazione di VsWorker",
  ...
  "desktop.menu.ariaLabel": "Menu VsWorker",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare VsWorker",
  "desktop.recovery.terminated": "La finestra di VsWorker si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "VsWorker non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di VsWorker non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.opencodeMissing": "VsWorker non è installato in questa distribuzione",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di VsWorker è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
