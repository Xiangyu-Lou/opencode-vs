export const dict = {
  ...
  "desktop.recovery.loadFailed": "VsWorker gagal dimuat",
  "desktop.recovery.terminated": "Jendela VsWorker berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "VsWorker tidak merespons",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di VsWorker.",
  ...
  "dialog.server.description": "Ganti server VsWorker mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa VsWorker di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui VsWorker di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui VsWorker di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker siap.",
  "wsl.onboarding.installOpencodeIn": "Instal VsWorker di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum VsWorker dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "VsWorker tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru VsWorker ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim VsWorker",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: VsWorker belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server VsWorker di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk VsWorker",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan VsWorker di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah VsWorker mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat VsWorker diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru VsWorker.",
