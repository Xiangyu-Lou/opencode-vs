export const dict = {
  ...
  "desktop.menu.documentation": "Documentație VsWorker",
  ...
  "desktop.menu.ariaLabel": "Meniu VsWorker",
  ...
  "desktop.recovery.loadFailed": "VsWorker nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra VsWorker s-a închis neașteptat",
  "desktop.recovery.unresponsive": "VsWorker nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea VsWorker a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.opencodeMissing": "VsWorker nu este instalat în această distribuție",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea VsWorker s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în VsWorker.",
  ...
  "dialog.server.description": "Schimbă serverul VsWorker la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică VsWorker în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează VsWorker în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează VsWorker în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker este gata în {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează VsWorker în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca VsWorker să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "VsWorker nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune VsWorker ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei VsWorker",
  ...
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, VsWorker nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul VsWorker în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru VsWorker",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul VsWorker pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă VsWorker urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema VsWorker.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea VsWorker",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune VsWorker.",
