export const dict = {
  ...
  "desktop.menu.documentation": "Documentation de VsWorker",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement de VsWorker",
  "desktop.recovery.terminated": "La fenêtre VsWorker s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "VsWorker ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation de VsWorker",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.opencodeMissing": "VsWorker n'est pas installé dans cette distribution",
  "desktop.wsl.error.opencodeCannotRun": "VsWorker est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.opencodeNotInstalled": "VsWorker n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour de VsWorker est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans VsWorker.",
  ...
  "dialog.server.description": "Changez le serveur VsWorker auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification de VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification de VsWorker dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour de VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour de VsWorker dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour VsWorker dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez VsWorker dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant que VsWorker puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "VsWorker n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version de VsWorker ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe VsWorker",
  ...
  "error.chain.mcpFailed":
    'Le serveur MCP "{{name}}" a échoué. Notez que VsWorker ne prend pas encore en charge l\'authentification MCP.',
  ...
  "sidebar.gettingStarted.line1":
    "VsWorker inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur VsWorker dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour VsWorker",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence de VsWorker sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si VsWorker suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème de VsWorker.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement de VsWorker",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version de VsWorker.",
