...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by VsWorker",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in VsWorker.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in VsWorker.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in VsWorker.",
  ...
  "dialog.server.description": "Switch which VsWorker server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking VsWorker...",
  "wsl.onboarding.checkingOpencodeIn": "Checking VsWorker in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating VsWorker...",
  "wsl.onboarding.updatingOpencodeIn": "Updating VsWorker in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update VsWorker in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update VsWorker",
  "wsl.onboarding.opencodeReadyIn": "VsWorker is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "VsWorker is ready.",
  "wsl.onboarding.installOpencodeIn": "Install VsWorker in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install VsWorker",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "VsWorker not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before VsWorker can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "VsWorker could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen VsWorker.",
  ...
  "help.tabs.introduction": "VsWorker Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of VsWorker ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the VsWorker team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, VsWorker does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "VsWorker includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the VsWorker server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for VsWorker",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how VsWorker looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether VsWorker follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how VsWorker is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when VsWorker launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of VsWorker.",
