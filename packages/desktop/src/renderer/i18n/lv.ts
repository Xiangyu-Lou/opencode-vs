export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko VsWorker versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "VsWorker versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
