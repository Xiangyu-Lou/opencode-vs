export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} VsWorker завантажено. Бажаєте встановити її та перезапустити?",
