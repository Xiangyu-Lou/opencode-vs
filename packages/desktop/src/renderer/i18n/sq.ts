export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i VsWorker është shkarkuar, dëshironi ta instaloni dhe rinisni?",
