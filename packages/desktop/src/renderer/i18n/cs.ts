export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace VsWorker. Chcete ji nainstalovat a aplikaci znovu spustit?",
