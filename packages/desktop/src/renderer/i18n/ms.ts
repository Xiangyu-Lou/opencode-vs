export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} VsWorker telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
