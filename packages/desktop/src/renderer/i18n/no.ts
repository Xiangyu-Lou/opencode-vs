export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av VsWorker er lastet ned. Vil du installere den og starte på nytt?",
