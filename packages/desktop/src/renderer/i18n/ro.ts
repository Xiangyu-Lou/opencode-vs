export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} VsWorker a fost descărcată. Vrei să o instalezi și să repornești?",
