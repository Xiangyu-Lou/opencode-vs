export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av VsWorker har laddats ned. Vill du installera den och starta om programmet?",
