export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የVsWorker ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከVsWorker ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
