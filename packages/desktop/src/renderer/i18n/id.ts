export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "VsWorker versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
