export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju VsWorker-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} VsWorker-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
