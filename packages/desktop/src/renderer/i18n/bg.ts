export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от VsWorker е изтеглена. Искате ли да я инсталирате и рестартирате?",
