export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią VsWorker versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "VsWorker versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
