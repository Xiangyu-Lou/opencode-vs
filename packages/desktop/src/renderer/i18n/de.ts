export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von VsWorker wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
