export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo VsWorkern uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "VsWorkern versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää VsWorkern uudelleen?",
