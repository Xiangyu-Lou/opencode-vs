export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version de VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} de VsWorker a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
