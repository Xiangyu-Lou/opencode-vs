export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van VsWorker is gedownload. Wil je deze installeren en VsWorker opnieuw starten?",
