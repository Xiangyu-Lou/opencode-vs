export const dict = {
  ...
  "desktop.updater.none.message": "Ja utilitzeu la versió més recent de VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "S'ha baixat la versió {{version}} de VsWorker. Voleu instal·lar-la i reiniciar l'aplicació?",
