export const dict = {
  ...
  "desktop.updater.none.message": "Þú ert nú þegar að nota nýjustu útgáfuna af VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáfu {{version}} af VsWorker hefur verið hlaðið niður. Viltu setja hana upp og endurræsa?",
