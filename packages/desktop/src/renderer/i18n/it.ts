export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di VsWorker è stata scaricata. Vuoi installarla e riavviare l'app?",
