export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} VsWorker je bila prenesena, jo želite namestiti in znova zagnati?",
