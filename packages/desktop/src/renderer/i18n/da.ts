export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af VsWorker er blevet downloadet. Vil du installere den og genstarte?",
