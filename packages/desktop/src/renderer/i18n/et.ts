export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse VsWorker uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "VsWorker'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
