export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} VsWorker. Czy chcesz ją zainstalować i uruchomić ponownie?",
