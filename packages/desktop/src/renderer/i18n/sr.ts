export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од VsWorker је преузета, да ли желите да је инсталирате и поново покренете?",
