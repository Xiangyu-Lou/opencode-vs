export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de VsWorker",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de VsWorker. ¿Quieres instalarla y reiniciar?",
